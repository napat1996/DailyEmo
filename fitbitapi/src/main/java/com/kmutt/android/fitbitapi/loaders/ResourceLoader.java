...
import com.kmutt.android.fitbitapi.APIUtils;
...
public class ResourceLoader<T> extends AsyncTaskLoader<ResourceLoaderResult<T>> {
    ...
    private final RestrictTo.Scope[] requiredScopes;

    public ResourceLoader(Activity context, String url, RestrictTo.Scope[] requiredScopes, Handler handler, Class<T> classType) {
        super(context);
